...
`+l+`\r
`),s.push(`--${o}--\r
`);let p=new TextEncoder,h=s.map(A=>typeof A=="string"?p.encode(A):A),g=await new Blob(h).arrayBuffer(),m={method:"POST",url:r,contentType:`multipart/form-data; boundary=${o}`,body:g},b=await(await(0,$.requestUrl)(m)).json;return(b.errcode===void 0||b.errcode==0)&&this.plugin.messageService.sendMessage(n+"-item-updated",b),{url:b.url||"",media_id:b.media_id||"",errcode:b.errcode||0,errmsg:b.errmsg||""}}async uploadMaterial(t,e,n){if(n==="video"){if(t.size>1024*1024*10)return new $.Notice(u("wechat-api.video-size-exceeds-10m")),!1}else if(n==="voice"){if(t.size>1024*1024*2)return new $.Notice(u("wechat-api.voice-size-exceeds-2m")),!1}else if(t.size>1024*1024*10)return new $.Notice(u("wechat-api.image-size-exceeds-10m")),!1;let i=await this.plugin.refreshAccessToken(this.plugin.settings.selectedMPAccount);if(!i)return!1;let r=`https://api.weixin.qq.com/cgi-bin/media/uploadimg?access_token=${i}`;n===void 0&&t.size>=1024*1024&&(n="image"),n!==void 0&&(r=`https://api.weixin.qq.com/cgi-bin/material/add_material?access_token=${i}&type=${n}`);let a={title:"title of video",introduction:"content of video"},o=await(0,$.getBlobArrayBuffer)(t),s=e,l="----WebKitFormBoundary"+Math.random().toString(36).substring(2),d=[];d.push(`--${l}\r
...
`+JSON.stringify(a)+`\r
`),d.push(`--${l}--\r
`);let p=new TextEncoder,h=d.map(g=>typeof g=="string"?p.encode(g):g).reduce((g,m)=>{let f=new Uint8Array(g.length+m.length);return f.set(g),f.set(m,g.length),f},new Uint8Array(0));try{this.plugin.showSpinner(u("wechat-api.uploading-material-type",[n||"unknown"]));let g=await(0,$.requestUrl)({url:r,method:"POST",headers:{"Content-Type":`multipart/form-data; boundary=${l}`},body:h.buffer});this.plugin.hideSpinner();let m=await g.json;return m.errcode!==void 0&&m.errcode!==0?(console.error("\u4E0A\u4F20\u7D20\u6750\u5931\u8D25:",m),new $.Notice(xe(m.errcode)||m.errmsg||"\u4E0A\u4F20\u7D20\u6750\u5931\u8D25",0),null):(this.plugin.messageService.sendMessage(n+"-item-updated",m),{url:m.url||"",media_id:m.media_id||"",errcode:m.errcode||0,errmsg:m.errmsg||""})}catch(g){throw this.plugin.hideSpinner(),console.error("\u4E0A\u4F20\u7D20\u6750\u65F6\u51FA\u9519:",g),g}}async getMaterialList(t,e,n=0,i=20){let r=await this.plugin.refreshAccessToken(t);if(!r)return!1;let a=`${this.baseUrl}/material/batchget_material?access_token=${r}`,o={type:e,offset:n,count:i},s={url:a,method:"POST",headers:this.getHeaders(),body:JSON.stringify(o)};return(await(0,$.requestUrl)(s)).json}async getMaterialById(t,e){if(!t)return!1;e===void 0&&(e=this.plugin.settings.selectedMPAccount);let n=await this.plugin.refreshAccessToken(e);if(!n)return!1;let i=`${this.baseUrl}/material/get_material?access_token=${n}`,r={media_id:t},a={url:i,method:"POST",headers:this.getHeaders(),body:JSON.stringify(r)};return(await(0,$.requestUrl)(a)).json}async getBatchDraftList(t,e=0,n=20){let i=await this.plugin.refreshAccessToken(t);if(!i)return!1;let r=`${this.baseUrl}/draft/batchget?access_token=${i}`,a={offset:e,count:n,no_content:!1},o={url:r,method:"POST",headers:this.getHeaders(),body:JSON.stringify(a)};return(await(0,$.requestUrl)(o)).json}async getMaterialCounts(t){let e=await this.plugin.refreshAccessToken(t);if(!e)return!1;let i={url:`${this.baseUrl}/material/get_materialcount?access_token=${e}`,method:"GET",headers:this.getHeaders()},r=await(0,$.requestUrl)(i),{errcode:a}=r.json;return a!==void 0&&a!==0?(new $.Notice(xe(a),0),!1):r.json}async getDraftCount(t){let e=await this.plugin.refreshAccessToken(t);if(!e)return!1;let i={url:`${this.baseUrl}/draft/count?access_token=${e}`,method:"GET",headers:this.getHeaders()},r=await(0,$.requestUrl)(i),{errcode:a,total_count:o}=r.json;return a!==void 0&&a!==0?(new $.Notice(xe(a),0),!1):o}async getDraftById(t,e){let n=await this.plugin.refreshAccessToken(t);if(!n)return!1;let i=`${this.baseUrl}/draft/get?access_token=${n}`,r={media_id:e},a={url:i,method:"POST",headers:this.getHeaders(),body:JSON.stringify(r)},o=await(0,$.requestUrl)(a),{errcode:s,news_item:l}=o.json;return s!==void 0&&s!==0?(new $.Notice(xe(s),0),!1):l}async publishDraft(t,e=""){e||(e=this.plugin.settings.selectedMPAccount);let n=await this.plugin.refreshAccessToken(e);if(!n)return!1;let i=`${this.baseUrl}/freepublish/submit?access_token=${n}`,r={media_id:t},a={url:i,method:"POST",headers:this.getHeaders(),body:JSON.stringify(r)},o=await(0,$.requestUrl)(a),{errcode:s,publish_id:l}=o.json;return s!==void 0&&s!==0?(new $.Notice(xe(s),0),!1):l}async deleteMedia(t,e=""){e||(e=this.plugin.settings.selectedMPAccount);let n=await this.plugin.refreshAccessToken(e);if(!n)return!1;let i=`${this.baseUrl}/material/del_material?access_token=${n}`,r={media_id:t},a={url:i,method:"POST",headers:this.getHeaders(),body:JSON.stringify(r)},o=await(0,$.requestUrl)(a),{errcode:s}=o.json;return s!==void 0&&s!==0?(new $.Notice(xe(s),0),!1):!0}async deleteDraft(t,e=""){e||(e=this.plugin.settings.selectedMPAccount);let n=await this.plugin.refreshAccessToken(e);if(!n)return!1;let i=`${this.baseUrl}/draft/delete?access_token=${n}`,r={media_id:t},a={url:i,method:"POST",headers:this.getHeaders(),body:JSON.stringify(r)},o=await(0,$.requestUrl)(a),{errcode:s}=o.json;return s!==void 0&&s!==0?(new $.Notice(xe(s),0),!1):!0}async massSendAll(t,e=""){e||(e=this.plugin.settings.selectedMPAccount);let n=await this.plugin.refreshAccessToken(e);if(!n)return!1;let i=`${this.baseUrl}/message/mass/sendall?access_token=${n}`,r={filter:{is_to_all:!0},mpnews:{media_id:t},msgtype:"mpnews"},a={url:i,method:"POST",headers:this.getHeaders(),body:JSON.stringify(r)},o=await(0,$.requestUrl)(a),{errcode:s}=o.json;return s!==void 0&&s!==0?(new $.Notice(xe(s),0),!1):!0}async senfForPreview(t,e="",n=""){n||(n=this.plugin.settings.selectedMPAccount),e||(e=this.plugin.settings.previewer_wxname);let i=await this.plugin.refreshAccessToken(n);if(!i)return!1;let r=`${this.baseUrl}/message/mass/preview?access_token=${i}`,a={towxname:e,mpnews:{media_id:t},msgtype:"mpnews"},o={url:r,method:"POST",headers:this.getHeaders(),body:JSON.stringify(a)},s=await(0,$.requestUrl)(o),{errcode:l}=s.json;return l!==void 0&&l!==0?(new $.Notice(xe(l),0),!1):!0}},Me=Ke;Me.instance=null});function Zn(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}function ba(c){Ye=c}function U(c,t=""){let e=typeof c=="string"?c:c.source,n={replace:(i,r)=>{let a=typeof r=="string"?r:r.source;return a=a.replace(fe.caret,"$1"),e=e.replace(i,a),n},getRegex:()=>new RegExp(e,t)};return n}function Oe(c,t){if(t){if(fe.escapeTest.test(c))return c.replace(fe.escapeReplace,ga)}else if(fe.escapeTestNoEncode.test(c))return c.replace(fe.escapeReplaceNoEncode,ga);return c}function ma(c){try{c=encodeURI(c).replace(fe.percentDecode,"%")}catch(t){return null}return c}function fa(c,t){var r;let e=c.replace(fe.findPipe,(a,o,s)=>{let l=!1,d=o;for(;--d>=0&&s[d]==="\\";)l=!l;return l?"|":" |"}),n=e.split(fe.splitPipe),i=0;if(n[0].trim()||n.shift(),n.length>0&&!((r=n.at(-1))!=null&&r.trim())&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;i<n.length;i++)n[i]=n[i].trim().replace(fe.slashPipe,"|");return n}function Et(c,t,e){let n=c.length;if(n===0)return"";let i=0;for(;i<n&&c.charAt(n-i-1)===t;)i++;return c.slice(0,n-i)}function $l(c,t){if(c.indexOf(t[1])===-1)return-1;let e=0;for(let n=0;n<c.length;n++)if(c[n]==="\\")n++;else if(c[n]===t[0])e++;else if(c[n]===t[1]&&(e--,e<0))return n;return-1}function va(c,t,e,n,i){let r=t.href,a=t.title||null,o=c[1].replace(i.other.outputLinkReplace,"$1");if(c[0].charAt(0)!=="!"){n.state.inLink=!0;let s={type:"link",raw:e,href:r,title:a,text:o,tokens:n.inlineTokens(o)};return n.state.inLink=!1,s}return{type:"image",raw:e,href:r,title:a,text:o}}function Il(c,t,e){let n=c.match(e.other.indentCodeCompensation);if(n===null)return t;let i=n[1];return t.split(`
`).map(r=>{let a=r.match(e.other.beginningSpace);if(a===null)return r;let[o]=a;return o.length>=i.length?r.slice(i.length):r}).join(`
`)}function W(c,t){return Ze.parse(c,t)}var Ye,Mt,fe,Qs,el,tl,Lt,nl,wa,xa,Yn,il,Xn,rl,al,tn,Qn,ol,ya,sl,ei,ua,ll,cl,dl,pl,ka,hl,nn,ti,Sa,ul,Ca,gl,ml,fl,Pa,vl,bl,Ta,wl,xl,yl,kl,Sl,Cl,Pl,en,Tl,Ea,Ma,El,ni,Ml,Jn,Al,Qt,Tt,Ll,ga,ut,ve,gt,At,be,Je,Be,Ze,Op,_p,Hp,Np,zp,Bp,jp,rn=y(()=>{Ye=Zn();Mt={exec:()=>null};fe={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:c=>new RegExp(`^( {0,3}${c})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:c=>new RegExp(`^ {0,${Math.min(3,c-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:c=>new RegExp(`^ {0,${Math.min(3,c-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:c=>new RegExp(`^ {0,${Math.min(3,c-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:c=>new RegExp(`^ {0,${Math.min(3,c-1)}}#`),htmlBeginRegex:c=>new RegExp(`^ {0,${Math.min(3,c-1)}}<(?:[a-z].*>|!--)`,"i")},Qs=/^(?:[ \t]*(?:\n|$))+/,el=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,tl=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Lt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,nl=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,wa=/(?:[*+-]|\d{1,9}[.)])/,xa=U(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,wa).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).getRegex(),Yn=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,il=/^[^\n]+/,Xn=/(?!\s*\])(?:\\.|[^\[\]\\])+/,rl=U(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Xn).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),al=U(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,wa).getRegex(),tn="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Qn=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ol=U("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Qn).replace("tag",tn).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ya=U(Yn).replace("hr",Lt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tn).getRegex(),sl=U(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ya).getRegex(),ei={blockquote:sl,code:el,def:rl,fences:tl,heading:nl,hr:Lt,html:ol,lheading:xa,list:al,newline:Qs,paragraph:ya,table:Mt,text:il},ua=U("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Lt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tn).getRegex(),ll={...ei,table:ua,paragraph:U(Yn).replace("hr",Lt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ua).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",tn).getRegex()},cl={...ei,html:U(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Qn).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Mt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:U(Yn).replace("hr",Lt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",xa).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},dl=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,pl=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ka=/^( {2,}|\\)\n(?!\s*$)/,hl=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,nn=/[\p{P}\p{S}]/u,ti=/[\s\p{P}\p{S}]/u,Sa=/[^\s\p{P}\p{S}]/u,ul=U(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,ti).getRegex(),Ca=/(?!~)[\p{P}\p{S}]/u,gl=/(?!~)[\s\p{P}\p{S}]/u,ml=/(?:[^\s\p{P}\p{S}]|~)/u,fl=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,Pa=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,vl=U(Pa,"u").replace(/punct/g,nn).getRegex(),bl=U(Pa,"u").replace(/punct/g,Ca).getRegex(),Ta="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",wl=U(Ta,"gu").replace(/notPunctSpace/g,Sa).replace(/punctSpace/g,ti).replace(/punct/g,nn).getRegex(),xl=U(Ta,"gu").replace(/notPunctSpace/g,ml).replace(/punctSpace/g,gl).replace(/punct/g,Ca).getRegex(),yl=U("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Sa).replace(/punctSpace/g,ti).replace(/punct/g,nn).getRegex(),kl=U(/\\(punct)/,"gu").replace(/punct/g,nn).getRegex(),Sl=U(/^<(scheme:[^\s<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Cl=U(Qn).replace("(?:-->|$)","-->").getRegex(),Pl=U("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Cl).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),en=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Tl=U(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",en).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Ea=U(/^!?\[(label)\]\[(ref)\]/).replace("label",en).replace("ref",Xn).getRegex(),Ma=U(/^!?\[(ref)\](?:\[\])?/).replace("ref",Xn).getRegex(),El=U("reflink|nolink(?!\\()","g").replace("reflink",Ea).replace("nolink",Ma).getRegex(),ni={_backpedal:Mt,anyPunctuation:kl,autolink:Sl,blockSkip:fl,br:ka,code:pl,del:Mt,emStrongLDelim:vl,emStrongRDelimAst:wl,emStrongRDelimUnd:yl,escape:dl,link:Tl,nolink:Ma,punctuation:ul,reflink:Ea,reflinkSearch:El,tag:Pl,text:hl,url:Mt},Ml={...ni,link:U(/^!?\[(label)\]\((.*?)\)/).replace("label",en).getRegex(),reflink:U(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",en).getRegex()},Jn={...ni,emStrongRDelimAst:xl,emStrongLDelim:bl,url:U(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},Al={...Jn,br:U(ka).replace("{2,}","*").getRegex(),text:U(Jn.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Qt={normal:ei,gfm:ll,pedantic:cl},Tt={normal:ni,gfm:Jn,breaks:Al,pedantic:Ml},Ll={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ga=c=>Ll[c];ut=class{constructor(t){K(this,"options");K(this,"rules");K(this,"lexer");this.options=t||Ye}space(t){let e=this.rules.block.newline.exec(t);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(t){let e=this.rules.block.code.exec(t);if(e){let n=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?n:Et(n,`
`)}}}fences(t){let e=this.rules.block.fences.exec(t);if(e){let n=e[0],i=Il(n,e[3]||"",this.rules);return{type:"code",raw:n,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:i}}}heading(t){let e=this.rules.block.heading.exec(t);if(e){let n=e[2].trim();if(this.rules.other.endingHash.test(n)){let i=Et(n,"#");(this.options.pedantic||!i||this.rules.other.endingSpaceChar.test(i))&&(n=i.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:n,tokens:this.lexer.inline(n)}}}hr(t){let e=this.rules.block.hr.exec(t);if(e)return{type:"hr",raw:Et(e[0],`
...
`+o.raw,l.text+=`
`+o.raw,this.inlineQueue.at(-1).src=l.text):this.tokens.links[o.tag]||(this.tokens.links[o.tag]={href:o.href,title:o.title});continue}if(o=this.tokenizer.table(t)){t=t.substring(o.raw.length),e.push(o);continue}if(o=this.tokenizer.lheading(t)){t=t.substring(o.raw.length),e.push(o);continue}let s=t;if((a=this.options.extensions)!=null&&a.startBlock){let l=1/0,d=t.slice(1),p;this.options.extensions.startBlock.forEach(h=>{p=h.call({lexer:this},d),typeof p=="number"&&p>=0&&(l=Math.min(l,p))}),l<1/0&&l>=0&&(s=t.substring(0,l+1))}if(this.state.top&&(o=this.tokenizer.paragraph(s))){let l=e.at(-1);n&&(l==null?void 0:l.type)==="paragraph"?(l.raw+=`
`+o.raw,l.text+=`
...
`+o.raw,l.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=l.text):e.push(o);continue}if(t){let l="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(l);break}else throw new Error(l)}}return this.state.top=!0,e}inline(t,e=[]){return this.inlineQueue.push({src:t,tokens:e}),e}inlineTokens(t,e=[]){var o,s,l;let n=t,i=null;if(this.tokens.links){let d=Object.keys(this.tokens.links);if(d.length>0)for(;(i=this.tokenizer.rules.inline.reflinkSearch.exec(n))!=null;)d.includes(i[0].slice(i[0].lastIndexOf("[")+1,-1))&&(n=n.slice(0,i.index)+"["+"a".repeat(i[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(i=this.tokenizer.rules.inline.blockSkip.exec(n))!=null;)n=n.slice(0,i.index)+"["+"a".repeat(i[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(i=this.tokenizer.rules.inline.anyPunctuation.exec(n))!=null;)n=n.slice(0,i.index)+"++"+n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let r=!1,a="";for(;t;){r||(a=""),r=!1;let d;if((s=(o=this.options.extensions)==null?void 0:o.inline)!=null&&s.some(h=>(d=h.call({lexer:this},t,e))?(t=t.substring(d.raw.length),e.push(d),!0):!1))continue;if(d=this.tokenizer.escape(t)){t=t.substring(d.raw.length),e.push(d);continue}if(d=this.tokenizer.tag(t)){t=t.substring(d.raw.length),e.push(d);continue}if(d=this.tokenizer.link(t)){t=t.substring(d.raw.length),e.push(d);continue}if(d=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(d.raw.length);let h=e.at(-1);d.type==="text"&&(h==null?void 0:h.type)==="text"?(h.raw+=d.raw,h.text+=d.text):e.push(d);continue}if(d=this.tokenizer.emStrong(t,n,a)){t=t.substring(d.raw.length),e.push(d);continue}if(d=this.tokenizer.codespan(t)){t=t.substring(d.raw.length),e.push(d);continue}if(d=this.tokenizer.br(t)){t=t.substring(d.raw.length),e.push(d);continue}if(d=this.tokenizer.del(t)){t=t.substring(d.raw.length),e.push(d);continue}if(d=this.tokenizer.autolink(t)){t=t.substring(d.raw.length),e.push(d);continue}if(!this.state.inLink&&(d=this.tokenizer.url(t))){t=t.substring(d.raw.length),e.push(d);continue}let p=t;if((l=this.options.extensions)!=null&&l.startInline){let h=1/0,g=t.slice(1),m;this.options.extensions.startInline.forEach(f=>{m=f.call({lexer:this},g),typeof m=="number"&&m>=0&&(h=Math.min(h,m))}),h<1/0&&h>=0&&(p=t.substring(0,h+1))}if(d=this.tokenizer.inlineText(p)){t=t.substring(d.raw.length),d.raw.slice(-1)!=="_"&&(a=d.raw.slice(-1)),r=!0;let h=e.at(-1);(h==null?void 0:h.type)==="text"?(h.raw+=d.raw,h.text+=d.text):e.push(d);continue}if(t){let h="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(h);break}else throw new Error(h)}}return e}},gt=class{constructor(t){K(this,"options");K(this,"parser");this.options=t||Ye}space(t){return""}code({text:t,lang:e,escaped:n}){var a;let i=(a=(e||"").match(fe.notSpaceStart))==null?void 0:a[0],r=t.replace(fe.endingNewline,"")+`
...
`+i+"</"+r+`>
`}listitem(t){var n;let e="";if(t.task){let i=this.checkbox({checked:!!t.checked});t.loose?((n=t.tokens[0])==null?void 0:n.type)==="paragraph"?(t.tokens[0].text=i+" "+t.tokens[0].text,t.tokens[0].tokens&&t.tokens[0].tokens.length>0&&t.tokens[0].tokens[0].type==="text"&&(t.tokens[0].tokens[0].text=i+" "+Oe(t.tokens[0].tokens[0].text),t.tokens[0].tokens[0].escaped=!0)):t.tokens.unshift({type:"text",raw:i+" ",text:i+" ",escaped:!0}):e+=i+" "}return e+=this.parser.parse(t.tokens,!!t.loose),`<li>${e}</li>
...
`}strong({tokens:t}){return`<strong>${this.parser.parseInline(t)}</strong>`}em({tokens:t}){return`<em>${this.parser.parseInline(t)}</em>`}codespan({text:t}){return`<code>${Oe(t,!0)}</code>`}br(t){return"<br>"}del({tokens:t}){return`<del>${this.parser.parseInline(t)}</del>`}link({href:t,title:e,tokens:n}){let i=this.parser.parseInline(n),r=ma(t);if(r===null)return i;t=r;let a='<a href="'+t+'"';return e&&(a+=' title="'+Oe(e)+'"'),a+=">"+i+"</a>",a}image({href:t,title:e,text:n}){let i=ma(t);if(i===null)return Oe(n);t=i;let r=`<img src="${t}" alt="${n}"`;return e&&(r+=` title="${Oe(e)}"`),r+=">",r}text(t){return"tokens"in t&&t.tokens?this.parser.parseInline(t.tokens):"escaped"in t&&t.escaped?t.text:Oe(t.text)}},At=class{strong({text:t}){return t}em({text:t}){return t}codespan({text:t}){return t}del({text:t}){return t}html({text:t}){return t}text({text:t}){return t}link({text:t}){return""+t}image({text:t}){return""+t}br(){return""}},be=class{constructor(t){K(this,"options");K(this,"renderer");K(this,"textRenderer");this.options=t||Ye,this.options.renderer=this.options.renderer||new gt,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new At}static parse(t,e){return new be(e).parse(t)}static parseInline(t,e){return new be(e).parseInline(t)}parse(t,e=!0){var i,r;let n="";for(let a=0;a<t.length;a++){let o=t[a];if((r=(i=this.options.extensions)==null?void 0:i.renderers)!=null&&r[o.type]){let l=o,d=this.options.extensions.renderers[l.type].call({parser:this},l);if(d!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(l.type)){n+=d||"";continue}}let s=o;switch(s.type){case"space":{n+=this.renderer.space(s);continue}case"hr":{n+=this.renderer.hr(s);continue}case"heading":{n+=this.renderer.heading(s);continue}case"code":{n+=this.renderer.code(s);continue}case"table":{n+=this.renderer.table(s);continue}case"blockquote":{n+=this.renderer.blockquote(s);continue}case"list":{n+=this.renderer.list(s);continue}case"html":{n+=this.renderer.html(s);continue}case"paragraph":{n+=this.renderer.paragraph(s);continue}case"text":{let l=s,d=this.renderer.text(l);for(;a+1<t.length&&t[a+1].type==="text";)l=t[++a],d+=`
`+this.renderer.text(l);e?n+=this.renderer.paragraph({type:"paragraph",raw:d,text:d,tokens:[{type:"text",raw:d,text:d,escaped:!0}]}):n+=d;continue}default:{let l='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return n}parseInline(t,e=this.renderer){var i,r;let n="";for(let a=0;a<t.length;a++){let o=t[a];if((r=(i=this.options.extensions)==null?void 0:i.renderers)!=null&&r[o.type]){let l=this.options.extensions.renderers[o.type].call({parser:this},o);if(l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(o.type)){n+=l||"";continue}}let s=o;switch(s.type){case"escape":{n+=e.text(s);break}case"html":{n+=e.html(s);break}case"link":{n+=e.link(s);break}case"image":{n+=e.image(s);break}case"strong":{n+=e.strong(s);break}case"em":{n+=e.em(s);break}case"codespan":{n+=e.codespan(s);break}case"br":{n+=e.br(s);break}case"del":{n+=e.del(s);break}case"text":{n+=e.text(s);break}default:{let l='Token with "'+s.type+'" type was not found.';if(this.options.silent)return console.error(l),"";throw new Error(l)}}}return n}},Je=class{constructor(t){K(this,"options");K(this,"block");this.options=t||Ye}preprocess(t){return t}postprocess(t){return t}processAllTokens(t){return t}provideLexer(){return this.block?ve.lex:ve.lexInline}provideParser(){return this.block?be.parse:be.parseInline}};K(Je,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));Be=class{constructor(...t){K(this,"defaults",Zn());K(this,"options",this.setOptions);K(this,"parse",this.parseMarkdown(!0));K(this,"parseInline",this.parseMarkdown(!1));K(this,"Parser",be);K(this,"Renderer",gt);K(this,"TextRenderer",At);K(this,"Lexer",ve);K(this,"Tokenizer",ut);K(this,"Hooks",Je);this.use(...t)}walkTokens(t,e){var i,r;let n=[];for(let a of t)switch(n=n.concat(e.call(this,a)),a.type){case"table":{let o=a;for(let s of o.header)n=n.concat(this.walkTokens(s.tokens,e));for(let s of o.rows)for(let l of s)n=n.concat(this.walkTokens(l.tokens,e));break}case"list":{let o=a;n=n.concat(this.walkTokens(o.items,e));break}default:{let o=a;(r=(i=this.defaults.extensions)==null?void 0:i.childTokens)!=null&&r[o.type]?this.defaults.extensions.childTokens[o.type].forEach(s=>{let l=o[s].flat(1/0);n=n.concat(this.walkTokens(l,e))}):o.tokens&&(n=n.concat(this.walkTokens(o.tokens,e)))}}return n}use(...t){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return t.forEach(n=>{let i={...n};if(i.async=this.defaults.async||i.async||!1,n.extensions&&(n.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){let a=e.renderers[r.name];a?e.renderers[r.name]=function(...o){let s=r.renderer.apply(this,o);return s===!1&&(s=a.apply(this,o)),s}:e.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let a=e[r.level];a?a.unshift(r.tokenizer):e[r.level]=[r.tokenizer],r.start&&(r.level==="block"?e.startBlock?e.startBlock.push(r.start):e.startBlock=[r.start]:r.level==="inline"&&(e.startInline?e.startInline.push(r.start):e.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(e.childTokens[r.name]=r.childTokens)}),i.extensions=e),n.renderer){let r=this.defaults.renderer||new gt(this.defaults);for(let a in n.renderer){if(!(a in r))throw new Error(`renderer '${a}' does not exist`);if(["options","parser"].includes(a))continue;let o=a,s=n.renderer[o],l=r[o];r[o]=(...d)=>{let p=s.apply(r,d);return p===!1&&(p=l.apply(r,d)),p||""}}i.renderer=r}if(n.tokenizer){let r=this.defaults.tokenizer||new ut(this.defaults);for(let a in n.tokenizer){if(!(a in r))throw new Error(`tokenizer '${a}' does not exist`);if(["options","rules","lexer"].includes(a))continue;let o=a,s=n.tokenizer[o],l=r[o];r[o]=(...d)=>{let p=s.apply(r,d);return p===!1&&(p=l.apply(r,d)),p}}i.tokenizer=r}if(n.hooks){let r=this.defaults.hooks||new Je;for(let a in n.hooks){if(!(a in r))throw new Error(`hook '${a}' does not exist`);if(["options","block"].includes(a))continue;let o=a,s=n.hooks[o],l=r[o];Je.passThroughHooks.has(a)?r[o]=d=>{if(this.defaults.async)return Promise.resolve(s.call(r,d)).then(h=>l.call(r,h));let p=s.call(r,d);return l.call(r,p)}:r[o]=(...d)=>{let p=s.apply(r,d);return p===!1&&(p=l.apply(r,d)),p}}i.hooks=r}if(n.walkTokens){let r=this.defaults.walkTokens,a=n.walkTokens;i.walkTokens=function(o){let s=[];return s.push(a.call(this,o)),r&&(s=s.concat(r.call(this,o))),s}}this.defaults={...this.defaults,...i}}),this}setOptions(t){return this.defaults={...this.defaults,...t},this}lexer(t,e){return ve.lex(t,e!=null?e:this.defaults)}parser(t,e){return be.parse(t,e!=null?e:this.defaults)}parseMarkdown(t){return(n,i)=>{let r={...i},a={...this.defaults,...r},o=this.onError(!!a.silent,!!a.async);if(this.defaults.async===!0&&r.async===!1)return o(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof n=="undefined"||n===null)return o(new Error("marked(): input parameter is undefined or null"));if(typeof n!="string")return o(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(n)+", string expected"));a.hooks&&(a.hooks.options=a,a.hooks.block=t);let s=a.hooks?a.hooks.provideLexer():t?ve.lex:ve.lexInline,l=a.hooks?a.hooks.provideParser():t?be.parse:be.parseInline;if(a.async)return Promise.resolve(a.hooks?a.hooks.preprocess(n):n).then(d=>s(d,a)).then(d=>a.hooks?a.hooks.processAllTokens(d):d).then(d=>a.walkTokens?Promise.all(this.walkTokens(d,a.walkTokens)).then(()=>d):d).then(d=>l(d,a)).then(d=>a.hooks?a.hooks.postprocess(d):d).catch(o);try{a.hooks&&(n=a.hooks.preprocess(n));let d=s(n,a);a.hooks&&(d=a.hooks.processAllTokens(d)),a.walkTokens&&this.walkTokens(d,a.walkTokens);let p=l(d,a);return a.hooks&&(p=a.hooks.postprocess(p)),p}catch(d){return o(d)}}}onError(t,e){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,t){let i="<p>An error occurred:</p><pre>"+Oe(n.message+"",!0)+"</pre>";return e?Promise.resolve(i):i}if(e)return Promise.reject(n);throw n}}},Ze=new Be;W.options=W.setOptions=function(c){return Ze.setOptions(c),W.defaults=Ze.defaults,ba(W.defaults),W};W.getDefaults=Zn;W.defaults=Ye;W.use=function(...c){return Ze.use(...c),W.defaults=Ze.defaults,ba(W.defaults),W};W.walkTokens=function(c,t){return Ze.walkTokens(c,t)};W.parseInline=Ze.parseInline;W.Parser=be;W.parser=be.parse;W.Renderer=gt;W.TextRenderer=At;W.Lexer=ve;W.lexer=ve.lex;W.Tokenizer=ut;W.Hooks=Je;W.parse=W;Op=W.options,_p=W.setOptions,Hp=W.use,Np=W.walkTokens,zp=W.parseInline,Bp=be.parse,jp=ve.lex});var se,ie,$t,ii,Xe,an=y(()=>{se={title:"\u6807\u9898",author:"\u4F5C\u8005",digest:"\u6458\u8981",sourceUrl:"\u539F\u6587\u94FE\u63A5",cover:"\u5C01\u9762\u56FE",openComment:"\u5F00\u542F\u8BC4\u8BBA",onlyFans:"\u4EC5\u7C89\u4E1D\u53EF\u8BC4\u8BBA"},ie={title:[se.title,"title"],author:[se.author,"author"],digest:[se.digest,"digest","description","summary"],sourceUrl:[se.sourceUrl,"content_source_url","source_url"],cover:[se.cover,"cover","thumbnail","one2mp_cover"],openComment:[se.openComment,"need_open_comment","open_comment"],onlyFans:[se.onlyFans,"only_fans_can_comment"]},$t=(c,t)=>{if(c)for(let e of t){let n=c[e];if(typeof n=="string"&&n.trim()!=="")return n.trim()}},ii=(c,t)=>{if(!c)return;let e=new Set(["1","true","yes","y","on","\u662F","\u5F00\u542F","\u5F00"]),n=new Set(["0","false","no","n","off","\u5426","\u5173\u95ED","\u5173"]);for(let i of t){let r=c[i];if(typeof r=="boolean")return r?1:0;if(typeof r=="number")return r>0?1:0;if(typeof r=="string"){let a=r.trim().toLowerCase();if(e.has(a))return 1;if(n.has(a))return 0}}},Xe=c=>{if(!c)return null;for(let t of ie.cover){let e=c[t];if(typeof e=="string"&&e.trim()!=="")return e.trim()}return null}});var Aa=Go((ri,ai)=>{(function(c){"use strict";let t=J(),e=le(),n=je(),i=He(),r={copyDefaultStyles:!0,imagePlaceholder:void 0,cacheBust:!1,useCredentials:!1,httpTimeout:3e4,styleCaching:"strict",corsImg:void 0},a={toSvg:p,toPng:g,toJpeg:m,toBlob:f,toPixelData:h,toCanvas:b,impl:{fontFaces:n,images:i,util:t,inliner:e,urlCache:[],options:{}}};typeof ri=="object"&&typeof ai=="object"?ai.exports=a:c.domtoimage=a;let o=(typeof Node=="undefined"?void 0:Node.ELEMENT_NODE)||1,s=(c===void 0?void 0:c.getComputedStyle)||(typeof window=="undefined"?void 0:window.getComputedStyle)||globalThis.getComputedStyle,l=(c===void 0?void 0:c.atob)||(typeof window=="undefined"?void 0:window.atob)||globalThis.atob;function d(x){return x===""||x==="none"}function p(x,w){let T=a.impl.util.getWindow(x);w||(w={}),A(w);let F=[];return Promise.resolve(x).then(O).then(k=>M(k,w,null,T)).then(Y).then(pe).then(N).then(B).then(E).then(I);function O(k){if(k.nodeType===o)return k;let L=k,X=k.parentNode,D=document.createElement("span");return L.replaceWith(D),D.append(k),F.push({parent:X,child:L,wrapper:D}),D}function E(k){for(;F.length>0;){let L=F.pop();L.parent.replaceChild(L.child,L.wrapper)}return k}function I(k){return a.impl.urlCache=[],Ne(),k}function N(k){if(w.bgcolor&&(k.style.backgroundColor=w.bgcolor),w.width&&(k.style.width=`${w.width}px`),w.height&&(k.style.height=`${w.height}px`),w.style)for(let X of Object.keys(w.style))k.style[X]=w.style[X];let L=null;return typeof w.onclone=="function"&&(L=w.onclone(k)),Promise.resolve(L).then(()=>k)}function B(k){let L=w.width||t.width(k),X=w.height||t.height(k);return Promise.resolve(k).then(D=>(D.setAttribute("xmlns","http://www.w3.org/1999/xhtml"),new XMLSerializer().serializeToString(D))).then(t.escapeXhtml).then(D=>{let ae=(t.isDimensionMissing(L)?' width="100%"':` width="${L}"`)+(t.isDimensionMissing(X)?' height="100%"':` height="${X}"`);return`<svg xmlns="http://www.w3.org/2000/svg"${(t.isDimensionMissing(L)?"":` width="${L}"`)+(t.isDimensionMissing(X)?"":` height="${X}"`)}><foreignObject${ae}>${D}</foreignObject></svg>`}).then(D=>`data:image/svg+xml;charset=utf-8,${D}`)}}function h(x,w){return S(x,w).then(T=>T.getContext("2d").getImageData(0,0,t.width(x),t.height(x)).data)}function g(x,w={}){return S(x,w).then(T=>T.toDataURL())}function m(x,w){return S(x,w).then(T=>T.toDataURL("image/jpeg",(w?w.quality:void 0)||1))}function f(x,w){return S(x,w).then(t.canvasToBlob)}function b(x,w){return S(x,w)}function A(x){x.copyDefaultStyles===void 0?a.impl.options.copyDefaultStyles=r.copyDefaultStyles:a.impl.options.copyDefaultStyles=x.copyDefaultStyles,x.imagePlaceholder===void 0?a.impl.options.imagePlaceholder=r.imagePlaceholder:a.impl.options.imagePlaceholder=x.imagePlaceholder,a.impl.options.cacheBust=x.cacheBust===void 0?r.cacheBust:x.cacheBust,a.impl.options.corsImg=x.corsImg===void 0?r.corsImg:x.corsImg,a.impl.options.useCredentials=x.useCredentials===void 0?r.useCredentials:x.useCredentials,a.impl.options.httpTimeout=x.httpTimeout===void 0?r.httpTimeout:x.httpTimeout,a.impl.options.styleCaching=x.styleCaching===void 0?r.styleCaching:x.styleCaching,a.impl.options.requestUrl=x.requestUrl,a.impl.options.type=x.type||"image/png",a.impl.options.quality=x.quality||1}function S(x,w){return w||(w={}),p(x,w).then(t.makeImage).then(F=>{let O=typeof w.scale=="number"?w.scale:1,E=T(x,O),I=E.getContext("2d");return I.msImageSmoothingEnabled=!1,I.imageSmoothingEnabled=!1,F&&(I.scale(O,O),I.drawImage(F,0,0)),E});function T(F,O){let E=w.width||t.width(F),I=w.height||t.height(F);t.isDimensionMissing(E)&&(E=t.isDimensionMissing(I)?300:I*2),t.isDimensionMissing(I)&&(I=E/2);let N=document.createElement("canvas");if(N.width=E*O,N.height=I*O,w.bgcolor){let B=N.getContext("2d");B.fillStyle=w.bgcolor,B.fillRect(0,0,N.width,N.height)}return N}}let C=null;function M(x,w,T,F){let O=w.filter;if(x===C||t.isHTMLScriptElement(x)||t.isHTMLStyleElement(x)||t.isHTMLLinkElement(x)||T!==null&&O&&!O(x))return Promise.resolve();return Promise.resolve(x).then(E).then(k=>N(k,I(x))).then(k=>B(k,x));function E(k){return t.isHTMLCanvasElement(k)?t.makeImage(k.toDataURL()):k.cloneNode(!1)}function I(k){return t.isElementHostForOpenShadowRoot(k)?k.shadowRoot:k}function N(k,L){let X=ne(L),D=Promise.resolve();if(X.length>0){let ee=s(ae(L));for(let he of t.asArray(X))D=D.then(()=>M(he,w,ee,F).then(te=>{te&&k.append(te)}))}return D.then(()=>k);function ae(ee){return t.isShadowRoot(ee)?ee.host:ee}function ne(ee){return t.isShadowSlotElement(ee)?ee.assignedNodes():ee.childNodes}}function B(k,L){if(!t.isElement(k)||t.isShadowSlotElement(L))return Promise.resolve(k);return Promise.resolve().then(X).then(D).then(ae).then(ne).then(()=>k);function X(){he(L,k);function ee(te,Q){Q.font=te.font,Q.fontFamily=te.fontFamily,Q.fontFeatureSettings=te.fontFeatureSettings,Q.fontKerning=te.fontKerning,Q.fontSize=te.fontSize,Q.fontStretch=te.fontStretch,Q.fontStyle=te.fontStyle,Q.fontVariant=te.fontVariant,Q.fontVariantCaps=te.fontVariantCaps,Q.fontVariantEastAsian=te.fontVariantEastAsian,Q.fontVariantLigatures=te.fontVariantLigatures,Q.fontVariantNumeric=te.fontVariantNumeric,Q.fontVariationSettings=te.fontVariationSettings,Q.fontWeight=te.fontWeight}function he(te,Q){let Ue=s(te);if(Ue.cssText)Q.style.cssText=Ue.cssText,ee(Ue,Q.style);else{if(In(w,te,Ue,T,Q),T===null){for(let nt of["inset-block","inset-block-start","inset-block-end"])Q.style.removeProperty(nt);for(let nt of["left","right","top","bottom"])Q.style.getPropertyValue(nt)&&$e(Q.style,nt,"0px")}let Ht="-webkit-background-clip",ft=Ue.getPropertyValue(Ht);ft&&ft!=="border-box"&&$e(Q.style,Ht,ft)}}}function D(){}function ae(){t.isHTMLTextAreaElement(L)&&(k.value=L.value,k.textContent=L.value),t.isHTMLInputElement(L)&&k.setAttribute("value",L.value)}function ne(){if(t.isSVGElement(k)&&(k.setAttribute("xmlns","http://www.w3.org/2000/svg"),t.isSVGRectElement(k)))for(let ee of["width","height"]){let he=k.getAttribute(ee);he&&(k.style[ee]=he)}}}}function Y(x){return Promise.resolve(x)}function pe(x){return i.inlineAll(x).then(()=>x)}function J(){let x=0;return{escape:Io,isDataUrl:te,canvasToBlob:Ht,resolveUrl:ft,getAndEncode:$o,uid:nt,delay:Do,asArray:Ro,escapeXhtml:Fo,makeImage:Lo,width:Oo,height:_o,getWindow:w,isElement:E,isElementHostForOpenShadowRoot:T,isShadowRoot:F,isInShadowRoot:O,isHTMLElement:N,isHTMLCanvasElement:I,isHTMLInputElement:k,isHTMLImageElement:B,isHTMLLinkElement:L,isHTMLScriptElement:X,isHTMLStyleElement:D,isHTMLTextAreaElement:ae,isShadowSlotElement:ne,isSVGElement:ee,isSVGRectElement:he,isDimensionMissing:Q};function w(v){let z=v?v.ownerDocument:void 0;return(z?z.defaultView:void 0)||c||window}function T(v){return E(v)&&v.shadowRoot!==null}function F(v){return v instanceof w(v).ShadowRoot}function O(v){return v!==null&&Object.hasOwn(v,"getRootNode")&&F(v.getRootNode())}function E(v){return v instanceof w(v).Element}function I(v){return v instanceof w(v).HTMLCanvasElement}function N(v){return v instanceof w(v).HTMLElement}function B(v){return v instanceof w(v).HTMLImageElement}function k(v){return v instanceof w(v).HTMLInputElement}function L(v){return v instanceof w(v).HTMLLinkElement}function X(v){return v instanceof w(v).HTMLScriptElement}function D(v){return v instanceof w(v).HTMLStyleElement}function ae(v){return v instanceof w(v).HTMLTextAreaElement}function ne(v){return O(v)&&v instanceof w(v).HTMLSlotElement}function ee(v){return v instanceof w(v).SVGElement}function he(v){return v instanceof w(v).SVGRectElement}function te(v){return v.search(/^(data:)/)!==-1}function Q(v){return isNaN(v)||v<=0}function Ue(v){return new Promise(z=>{let H=l(v.toDataURL().split(",")[1]),j=H.length,G=new Uint8Array(j);for(let Ce=0;Ce<j;Ce++)G[Ce]=H.charCodeAt(Ce);z(new Blob([G],{type:a.impl.options.type}))})}function Ht(v){return v.toBlob?new Promise(z=>{v.toBlob(z,a.impl.options.type,a.impl.options.quality)}):Ue(v)}function ft(v,z){let H=document.implementation.createHTMLDocument(),j=H.createElement("base");H.head.append(j);let G=H.createElement("a");return H.body.append(G),j.href=z,G.href=v,G.href}function nt(){return`u${v()}${x++}`;function v(){return`0000${Math.trunc(Math.random()*36**4).toString(36)}`.slice(-4)}}function Lo(v){return v==="data:,"?Promise.resolve():new Promise((z,H)=>{let j=new Image;a.impl.options.useCredentials&&(j.crossOrigin="use-credentials"),j.addEventListener("load",()=>{window&&window.requestAnimationFrame?window.requestAnimationFrame(()=>{z(j)}):z(j)}),j.onerror=H,j.src=v})}function $o(v){let z=a.impl.urlCache.find(H=>H.url===v);return z||(z={url:v,promise:null},a.impl.urlCache.push(z)),z.promise===null&&(a.impl.options.cacheBust&&(v+=(/\?/.test(v)?"&":"?")+Date.now()),a.impl.options.requestUrl&&v.startsWith("http")&&!v.startsWith("http://localhost/")?z.promise=a.impl.options.requestUrl({url:v,method:"GET"}).then(H=>new Promise(j=>{let G=new FileReader;G.addEventListener("load",Ce=>{j(Ce.target.result)}),G.readAsDataURL(new Blob([H.arrayBuffer],{type:H.headers["content-type"]}))})).catch(H=>(console.error("cannot fetch resource: "+v+", error: "+H),"")):z.promise=new Promise(H=>{let j=a.impl.options.httpTimeout,G=new XMLHttpRequest;if(G.addEventListener("readystatechange",Ho),G.ontimeout=No,G.responseType="blob",G.timeout=j,a.impl.options.useCredentials&&(G.withCredentials=!0),a.impl.options.corsImg&&v.indexOf("http")===0&&!v.includes(window.location.origin)){let we=(a.impl.options.corsImg.method||"GET").toUpperCase()==="POST"?"POST":"GET";G.open(we,(a.impl.options.corsImg.url||"").replace("#{cors}",v),!0);let Rn=!1,Fn=a.impl.options.corsImg.headers||{};for(let We of Object.keys(Fn))Fn[We].includes("application/json")&&(Rn=!0),G.setRequestHeader(We,Fn[We]);let rt=zo(a.impl.options.corsImg.data||"");for(let We of Object.keys(rt))typeof rt[We]=="string"&&(rt[We]=rt[We].replace("#{cors}",v));G.send(Rn?JSON.stringify(rt):rt)}else G.open("GET",v,!0),G.send();let Ce;if(a.impl.options.imagePlaceholder){let we=a.impl.options.imagePlaceholder.split(/,/);we&&we[1]&&(Ce=we[1])}function Ho(){if(G.readyState!==4)return;if(G.status>=300){Ce?H(Ce):Dn(`cannot fetch resource: ${v}, status: ${G.status}`);return}let we=new FileReader;we.onloadend=function(){H(we.result)},we.readAsDataURL(G.response)}function No(){Ce?H(Ce):Dn(`timeout of ${j}ms occured while fetching resource: ${v}`)}function zo(we){try{return JSON.parse(JSON.stringify(we))}catch(Rn){Dn("corsImg.data is missing or invalid")}}function Dn(we){console.error(we),H("")}})),z.promise}function Io(v){return v.replaceAll(/([.*+?^${}()|[\]\/\\])/g,"\\$1")}function Do(v){return function(z){return new Promise(H=>{setTimeout(()=>{H(z)},v)})}}function Ro(v){let z=[],H=v.length;for(let j=0;j<H;j++)z.push(v[j]);return z}function Fo(v){let z=v.replaceAll("%","%25").replaceAll("#","%23").replaceAll(`
`,"%0A"),H="";for(let j=0;j<z.length;j++){let G=z.charCodeAt(j);G<=31||G===127||(H+=z[j])}return H}function Oo(v){let z=it(v,"width");if(!isNaN(z))return z;let H=it(v,"border-left-width"),j=it(v,"border-right-width");return v.scrollWidth+H+j}function _o(v){let z=it(v,"height");if(!isNaN(z))return z;let H=it(v,"border-top-width"),j=it(v,"border-bottom-width");return v.scrollHeight+H+j}function it(v,z){if(v.nodeType===o){let H=s(v).getPropertyValue(z);if(H.slice(-2)==="px")return H=H.slice(0,-2),Number.parseFloat(H)}return Number.NaN}}function le(){let x=/url\(['"]?([^'"]+?)['"]?\)/g;return{inlineAll:O,shouldProcess:w,impl:{readUrls:T,inline:F}};function w(E){return E.search(x)!==-1}function T(E){let I=[],N;for(;(N=x.exec(E))!==null;)I.push(N[1]);return I.filter(B=>!t.isDataUrl(B))}function F(E,I,N,B){return Promise.resolve(I).then(L=>N?t.resolveUrl(L,N):L).then(B||t.getAndEncode).then(L=>E.replace(k(I),`$1${L}$3`));function k(L){return new RegExp(`(url\\(['"]?)(${t.escape(L)})(['"]?\\))`,"g")}}function O(E,I,N){if(B())return Promise.resolve(E);return Promise.resolve(E).then(T).then(k=>{let L=Promise.resolve(E);for(let X of k)L=L.then(D=>F(D,X,I,N));return L});function B(){return!w(E)}}}function je(){return{resolveAll:x,impl:{readAll:w}};function x(){return w().then(T=>Promise.all(T.map(F=>F.resolve()))).then(T=>T.join(`
`))}function w(){return Promise.resolve(t.asArray(document.styleSheets)).then(F).then(T).then(E=>E.map(O));function T(E){return E.filter(I=>I.type===CSSRule.FONT_FACE_RULE).filter(I=>e.shouldProcess(I.style.getPropertyValue("src")))}function F(E){let I=[];for(let N of E)if(Object.hasOwn(Object.getPrototypeOf(N),"cssRules"))try{t.asArray(N.cssRules||[]).forEach(I.push.bind(I))}catch(B){console.error(`domtoimage: Error while reading CSS rules from ${N.href}`,B.toString())}return I}function O(E){return{resolve:function(){let N=(E.parentStyleSheet||{}).href;return e.inlineAll(E.cssText,N)},src(){return E.style.getPropertyValue("src")}}}}}function He(){return{inlineAll:w,impl:{newImage:x}};function x(T){return{inline:F};function F(O){return t.isDataUrl(T.src)?Promise.resolve():Promise.resolve(T.src).then(O||t.getAndEncode).then(E=>new Promise(I=>{T.addEventListener("load",I),T.onerror=I,T.src=E}))}}function w(T){if(!t.isElement(T))return Promise.resolve(T);return F(T).then(()=>t.isHTMLImageElement(T)?x(T).inline():Promise.all(t.asArray(T.childNodes).map(O=>w(O))));function F(O){let I=["background","background-image"].map(N=>{let B=O.style.getPropertyValue(N),k=O.style.getPropertyPriority(N);return B?e.inlineAll(B).then(L=>{$e(O.style,N,L,k)}):Promise.resolve()});return Promise.all(I).then(()=>O)}}}function $e(x,w,T,F){let O=["background-clip"].includes(w),E=F?" !important":"";$n(x,w,T,E),O&&$n(x,`-webkit-${w}`,T,E)}function $n(x,w,T,F){if(!w)return;let O=x.cssText&&!x.cssText.trim().endsWith(";")?"; ":"";x.cssText+=`${O}${w}: ${T}${F};`}function In(x,w,T,F,O){let E=a.impl.options.copyDefaultStyles?_t(x,w):{},I=O.style;for(let B of N(t.asArray(T))){let k=T.getPropertyValue(B),L=E[B],X=F?F.getPropertyValue(B):void 0;if(k!==L||F&&k!==X||/border/.test(B)){let D=T.getPropertyPriority(B);$e(I,B,k,D)}}function N(B){for(let k of["counter-reset","counter-increment","counter-set"])B.indexOf(k)<0&&!d(T.getPropertyValue(k))&&B.push(k);return B}}let Ie=null,De={},tt=new Set(["ADDRESS","ARTICLE","ASIDE","BLOCKQUOTE","DETAILS","DIALOG","DD","DIV","DL","DT","FIELDSET","FIGCAPTION","FIGURE","FOOTER","FORM","H1","H2","H3","H4","H5","H6","HEADER","HGROUP","HR","LI","MAIN","NAV","OL","P","PRE","SECTION","SVG","TABLE","UL","math","svg","BODY","HEAD","HTML"]);function _t(x,w){let T=N(w),F=B(T);if(De[F])return De[F];let O=ge(),E=k(O.document,T),I=L(O,E);return X(E),De[F]=I,I;function N(D){let ae=[];do{if(D.nodeType===o){let ne=D.tagName;if(ae.push(ne),tt.has(ne))break}D=D.parentNode}while(D);return ae}function B(D){return x.styleCaching==="relaxed"?D.filter((ae,ne,ee)=>ne===0||ne===ee.length-1).join(">"):D.join(">")}function k(D,ae){let ne=D.body;do{let ee=ae.pop(),he=D.createElement(ee);ne.append(he),ne=he}while(ae.length>0);return ne.textContent="\u200B",ne}function L(D,ae){let ne={},ee=D.getComputedStyle(ae);for(let he of t.asArray(ee))ne[he]=he==="width"||he==="height"?"auto":ee.getPropertyValue(he);return ne}function X(D){do{let ae=D.parentElement;ae!==null&&D.remove(),D=ae}while(D&&D.tagName!=="BODY")}}function ge(){if(C)return C.contentWindow;let x=document.characterSet||"UTF-8",w=document.doctype,T=w?`<!DOCTYPE ${F(w.name)} ${F(w.publicId)} ${F(w.systemId)}`.trim()+">":"";return C=document.createElement("iframe"),C.id="domtoimage-sandbox-"+t.uid(),C.classList.add("one2mp-domtoimage-sandbox"),document.body.append(C),O(C,T,x,"domtoimage-sandbox");function F(E){return E?E.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;"):""}function O(E,I,N,B){let k=document.createElement("meta");k.setAttribute("charset",N);try{let L=document.implementation.createHTMLDocument(B);L.head.append(k);let X=new XMLSerializer,D=I+X.serializeToString(L.documentElement);return E.setAttribute("srcdoc",D),E.contentWindow}catch(L){}return E.contentDocument.head.append(k),E.contentDocument.title=B,E.contentWindow}}function Ne(){C&&(C.remove(),C=null),Ie&&clearTimeout(Ie),Ie=setTimeout(()=>{Ie=null,De={}},20*1e3)}})(ri)});var dn,La,re,It=y(()=>{dn=require("obsidian"),La=Ko(Aa()),re=class{constructor(t){this.app=t;this.rendering=!1;this.app=t}static getInstance(t){return re.instance||(re.instance=new re(t)),re.instance}async render(t,e,n){if(t===void 0||!t||!t.toLowerCase().endsWith(".md")||!e||!n)return;this.container=e,this.container.addClass("one2mp-markdown-render-container"),this.view=n,this.container.empty(),this.container.show(),this.rendering=!0,this.mdv&&this.mdv.unload(),this.previewEl=createDiv(),this.markdownBody=this.previewEl.createDiv(),this.mdv=new dn.MarkdownRenderChild(this.markdownBody),this.view.addChild(this.mdv),this.container.appendChild(this.previewEl);let i=await this.app.vault.adapter.read(t);await dn.MarkdownRenderer.render(this.app,i,this.markdownBody,t,this.mdv);try{let r=[];/^\s*>+\s*\[!/m.test(i)&&r.push(this.waitForSelector(this.previewEl,".callout",1e3)),/```\s*mermaid/i.test(i)&&r.push(this.waitForSelector(this.previewEl,".mermaid svg",5e3)),r.length&&await Promise.all(r)}catch(r){console.warn("\u90E8\u5206\u63D2\u4EF6\u6E32\u67D3\u8D85\u65F6\uFF08\u975E\u81F4\u547D\uFF09",r)}this.rendering=!1}queryElement(t,e){if(this.previewEl===void 0||!this.previewEl||this.rendering||this.previewEl===void 0||!this.previewEl)return null;let n=this.previewEl.querySelectorAll(e);return t<0||t>=n.length?null:n[t]}async domToImage(t,e={}){return await La.default.toPng(t,e)}waitForSelector(t,e,n=1e3){return new Promise(i=>{if(t.querySelector(e))return i();let r=new MutationObserver(()=>{t.querySelector(e)&&(r.disconnect(),i())});r.observe(t,{childList:!0,subtree:!0}),setTimeout(()=>{r.disconnect(),i()},n)})}}});var oi,_e,pn=y(()=>{oi=require("obsidian");Ee();_e=class{constructor(t){this.app=t}parseObsidianUrl(t){let e=/obsidian:\/\/open\?vault=(.*?)&file=([^,]*),?(.*)$/,n=t.match(e);return n&&n[2]?decodeURIComponent(n[2]):null}getFileFromPath(t){let e=this.app.vault.getAbstractFileByPath(t);return e instanceof oi.TFile?e:null}getDisplayUrl(t){if(t)try{return this.app.vault.getResourcePath(t)}catch(e){console.error("Error reading file:",e)}return null}getInternalLinkDisplayUrl(t){let e=this.parseObsidianUrl(t);if(e){let n=this.getFileFromPath(e);if(n)return this.getDisplayUrl(n)}return null}}});var ue,Ia,$a,si,Dl,Rl,Fl,Ol,_l,Hl,Da,Ra=y(()=>{ue=require("obsidian");an();pn();Ia=require("obsidian"),$a=c=>c.replace(/[\\/:*?"<>|]/g,"-").trim()||"\u672A\u547D\u540D",si=async(c,t)=>{c.vault.getAbstractFileByPath(t)||await c.vault.createFolder(t)},Dl=(c,t)=>{let e=c.vault.adapter;if(!(e instanceof Ia.FileSystemAdapter))return null;let n=e.getBasePath();if(!t.startsWith(n))return null;let i=t.slice(n.length);return(i.startsWith("/")||i.startsWith("\\"))&&(i=i.slice(1)),i.replace(/\\\\/g,"/")},Rl=(c,t)=>{var r,a;let e=(a=(r=c.metadataCache.getFileCache(t))==null?void 0:r.frontmatter)!=null?a:null,n=["\u5C0F\u7EA2\u4E66\u5C01\u9762\u56FE","\u5C0F\u7EA2\u4E66\u5C01\u9762","redbook_cover","xhs_cover"];for(let o of n){let s=e==null?void 0:e[o];if(typeof s=="string"&&s.trim())return s.trim()}let i=Xe(e);return i!=null?i:null},Fl=(c,t)=>{if(!t||!t.trim())return null;let e=t.trim();if(e.startsWith("vault:")&&(e=e.slice(6)),e.startsWith("obsidian://")){let i=new _e(c).parseObsidianUrl(e);i&&(e=i)}if(e.startsWith("file://")){let n=decodeURIComponent(e.replace("file://","")),i=Dl(c,n);i&&(e=i)}return e},Ol=(c,t,e)=>{if(ue.Platform.isMobile)return;let i=c.openWithDefaultApp;if(!i)return;let r=c.vault.adapter,a=r.getFullPath?r.getFullPath(t):t,o=l=>{try{i(l)}catch(d){console.debug("\u6253\u5F00\u6587\u4EF6\u5939\u5931\u8D25",d)}};if(o(a),o(`${a}/`),e){let l=r.getFullPath?r.getFullPath(e):e;o(l)}let s=typeof navigator!="undefined"?navigator.clipboard:void 0;s!=null&&s.writeText&&s.writeText(a)},_l=(c,t)=>{var d,p,h,g,m,f,b,A;let e=c.vault,n=c.workspace.getActiveFile(),i=e.config,r=(d=i==null?void 0:i.attachmentFolderPath)!=null?d:"",a=t.trim();if(!a)return null;a=a.split("|")[0].split("?")[0].split("#")[0],(a.startsWith("/")||a.startsWith("\\"))&&(a=a.slice(1));let o=e.getAbstractFileByPath(a);if(o instanceof ue.TFile)return o;let s=c.metadataCache.getFirstLinkpathDest(a,(p=n==null?void 0:n.path)!=null?p:"");if(s instanceof ue.TFile)return s;if((h=n==null?void 0:n.parent)!=null&&h.path){let S=`${n.parent.path}/${a}`,C=e.getAbstractFileByPath(S);if(C instanceof ue.TFile)return C}let l=a.split("/").pop()||a;if(r){let S=[];if(r.startsWith("./")){let C=r.slice(2);S.push(`${(m=(g=n==null?void 0:n.parent)==null?void 0:g.path)!=null?m:""}/${C}/${l}`),S.push(`${(b=(f=n==null?void 0:n.parent)==null?void 0:f.path)!=null?b:""}/${C}/${a}`)}else S.push(`${r}/${l}`),S.push(`${r}/${a}`),(A=n==null?void 0:n.parent)!=null&&A.path&&(S.push(`${n.parent.path}/${r}/${l}`),S.push(`${n.parent.path}/${r}/${a}`));for(let C of S){let M=e.getAbstractFileByPath(C);if(M instanceof ue.TFile)return M}}return null},Hl=()=>{let c=new Date,t=e=>String(e).padStart(2,"0");return`${c.getFullYear()}${t(c.getMonth()+1)}${t(c.getDate())}-${t(c.getHours())}${t(c.getMinutes())}${t(c.getSeconds())}`},Da=async(c,t,e)=>{var b;let n=await c.vault.cachedRead(t),i=await e.parse(n),r=Fl(c,Rl(c,t)),a=r?[r,...i.images.filter(A=>A!==r)]:i.images,o=((b=t.parent)==null?void 0:b.path)||"",s=o.includes("/")?o.split("/").slice(0,-1).join("/"):"",l=$a(t.basename),d=(0,ue.normalizePath)(`${s}/\u5C0F\u7EA2\u4E66\u5BFC\u51FA/${l}-${Hl()}`),p=(0,ue.normalizePath)(`${d}/\u56FE\u7247`);await si(c,(0,ue.normalizePath)(`${s}/\u5C0F\u7EA2\u4E66\u5BFC\u51FA`)),await si(c,d),await si(c,p);let h=(0,ue.normalizePath)(`${d}/\u6587\u6848.txt`);await c.vault.create(h,i.text);let g="",m=0;for(let A=0;A<a.length;A+=1){let S=a[A],C=A+1,M=_l(c,S);if(!M){g+=`\u56FE${C}: \u672A\u627E\u5230\uFF08${S}\uFF09
`;continue}let Y=M.extension||"png",pe=`${String(C).padStart(2,"0")}-${$a(M.basename)}.${Y}`,J=(0,ue.normalizePath)(`${p}/${pe}`),le=await c.vault.readBinary(M);await c.vault.adapter.writeBinary(J,le),g+=`\u56FE${C}: ${pe}\uFF08\u539F\u59CB\uFF1A${S}\uFF09
`,m+=1}let f=(0,ue.normalizePath)(`${d}/\u4E0A\u4F20\u987A\u5E8F.txt`);return await c.vault.create(f,g.trim()+`
`),new ue.Notice(`\u5C0F\u7EA2\u4E66\u7D20\u6750\u5DF2\u5BFC\u51FA\uFF1A${d}\uFF08${m}/${a.length}\uFF09`),Ol(c,d,f),{folder:d,imageCount:a.length,successCount:m}}});var ye,Nl,zl,Bl,jl,Vl,Fa,hn,Oa=y(()=>{rn();ye={heading:["\u2728","\u{1F539}","\u{1F538}"],listStyle:"\u25AB\uFE0F",orderedListStyle:["1\uFE0F\u20E3","2\uFE0F\u20E3","3\uFE0F\u20E3","4\uFE0F\u20E3","5\uFE0F\u20E3","6\uFE0F\u20E3","7\uFE0F\u20E3","8\uFE0F\u20E3","9\uFE0F\u20E3","\u{1F51F}"],taskListStyle:["\u{1F532}","\u2705"],hr:"---------------------"},Nl=c=>{if(!c.startsWith("---"))return c;let t=c.indexOf(`
---`,3);return t===-1?c:c.slice(t+4)},zl=c=>c.replace(/<[^>]*>/g,""),Bl=c=>c.replace(/!\[\[([^\]|#]+)(?:#[^\]|]+)?(?:\|[^\]]+)?\]\]/g,(t,e)=>{let n=String(e).trim();return n?`![](${n})`:""}),jl=(c,t)=>{let e=/!\[\[[^\]]+\]\]|!\[[^\]]*\]\([^)]+\)/g;for(let n of c.matchAll(e)){let i=n[0]||"";if(i){if(i.startsWith("![[")){let a=i.slice(3,-2).split("|")[0].split("#")[0].trim();a&&t(a);continue}if(i.startsWith("![")){let r=i.replace(/^!\[[^\]]*\]\(/,"").replace(/\)$/,"");r=r.trim(),r.startsWith("<")&&r.endsWith(">")&&(r=r.slice(1,-1).trim());let a=r.indexOf(" ");a>0&&(r=r.slice(0,a).trim()),r&&t(r)}}}},Vl=c=>c.replace(/\n{3,}/g,`

`).trim(),Fa=c=>ye.orderedListStyle[c-1]||`${c}.`,hn=class{buildRenderer(t){let e=a=>{if(a==null)return"";if(typeof a=="string")return a;let o=a;return typeof o.text=="string"?o.text:typeof o.raw=="string"?o.raw:""},n=(a,o)=>{let s=a;return s&&typeof s.depth=="number"?s.depth:s&&typeof s.level=="number"?s.level:typeof o=="number"?o:1},i=(a,o,s=1)=>{let l="",d=s;for(let p of a){let h=p.trim();if(!h)continue;if(o){l+=`${Fa(d)} ${h}
`,d+=1;continue}let g=h.startsWith(ye.taskListStyle[0])||h.startsWith(ye.taskListStyle[1]);l+=g?`${h}
`:`${ye.listStyle} ${h}
`}return`
${l}
`};return{heading(a,o){let s=e(a),l=n(a,o);return`${ye.heading[l-1]||""} ${s}
...
`},hr(){return`
${ye.hr}
`},list(a,o){var d,p;if(typeof a=="string"){let h=a.split(`
`);return i(h,!!o,1)}let s=(p=(d=a==null?void 0:a.ordered)!=null?d:o)!=null?p:!1,l=typeof(a==null?void 0:a.start)=="number"?a.start:1;if(Array.isArray(a==null?void 0:a.items)){let h="",g=l;for(let m of a.items){let f=e(m);if(s){h+=`${Fa(g)} ${f}
`,g+=1;continue}if(m!=null&&m.task){let b=m.checked?ye.taskListStyle[1]:ye.taskListStyle[0];h+=`${b} ${f}
`;continue}h+=`${ye.listStyle} ${f}
`}return`
${h}
`}return""},listitem(a,o,s){var h,g,m;if(typeof a=="string")return o?`${s?ye.taskListStyle[1]:ye.taskListStyle[0]} ${a}`:a;let l=e(a);return((g=(h=a==null?void 0:a.task)!=null?h:o)!=null?g:!1)?`${((m=a==null?void 0:a.checked)!=null?m:s)?ye.taskListStyle[1]:ye.taskListStyle[0]} ${l}`:l},link(a,o,s){var p,h,g;if(typeof a=="string")return a;let l=(p=a==null?void 0:a.href)!=null?p:"",d=(g=(h=a==null?void 0:a.text)!=null?h:s)!=null?g:"";return l?`${d}\uFF08\u94FE\u63A5\uFF1A${l}\uFF09`:d},image(a){var l;let o=(l=a==null?void 0:a.href)!=null?l:typeof a=="string"?a:"";return`\u3010\u56FE${t(o||"")}\u3011`},br(){return`
`}}}async parse(t){let e=Nl(t),n=[],i=new Set,r=d=>{let p=(d||"").trim();return p?(i.has(p)||(i.add(p),n.push(p)),n.indexOf(p)+1):n.length+1};jl(e,r);let a=Bl(e),o=new Be;o.use({gfm:!0,breaks:!0}),o.use({renderer:this.buildRenderer(r)});let s=await o.parse(a);return{text:Vl(zl(String(s))),images:n}}}});function un(c,t){let e="";return c&&c.includes("/")&&(e=c.split("/")[1]||""),e||(e=t||"png"),`image-${new Date().getTime()}.${e}`}function Ul(c){if(!c)return;let e=c.split("?")[0].split("#")[0].match(/\.([a-zA-Z0-9]+)$/);return e?e[1].toLowerCase():void 0}function gn(c,t){t.forEach(e=>{e.status==="rejected"&&console.error(`${c}\u4E0A\u4F20\u5931\u8D25:`,e.reason)})}function Wl(c){return new Promise((t,e)=>{let n=new Image;n.onload=()=>{let o=document.createElement("canvas"),s=window.devicePixelRatio||1;o.width=n.width*s,o.height=n.height*s;let l=o.getContext("2d");if(!l){e(new Error(u("render.faild-canvas-context")));return}l.drawImage(n,0,0),o.toBlob(d=>{d?t(d):e(new Error(u("render.failed-to-convert-canvas-to-blob")))},"image/png")},n.onerror=o=>{let s=o instanceof Error?o.message:typeof o=="string"?o:JSON.stringify(o);e(new Error(s))};let r=new TextEncoder().encode(c),a=String.fromCharCode.apply(null,r);n.src=`data:image/svg+xml;base64,${btoa(a)}`})}function li(c){let t=c.split(";base64,");console.debug("parts:",t);let e=t[0].split(":")[1];console.debug("contentType",e);let n=window.atob(t[1]);console.debug("raw:",n);let i=n.length,r=new Uint8Array(i);for(let a=0;a<i;++a)r[a]=n.charCodeAt(a);return console.debug("uInt8Array byteLength:",r.byteLength),new Blob([r],{type:e})}function ql(c){let t=c.toDataURL("image/png");return li(t)}async function _a(c,t){let e=[];c.querySelectorAll("svg").forEach(r=>{e.push(r)});let n=e.map(async r=>{let a=Pe(r);a.length<1e4||await Wl(a).then(async o=>{let s=await t.uploadMaterial(o,un(o.type,"png"));if(s&&s.url){let l=document.createElement("img");l.src=s.url,r.replaceWith(l)}else console.error("upload svg failed.")})}),i=await Promise.allSettled(n);gn("SVG",i)}async function Ha(c,t){let e=[];c.querySelectorAll("canvas").forEach(r=>{e.push(r)});let n=e.map(async r=>{let a=ql(r),o=await t.uploadMaterial(a,un(a.type,"png"));if(o&&o.url){let s=document.createElement("img");s.src=o.url,r.replaceWith(s)}else console.error("upload canvas failed.")}),i=await Promise.allSettled(n);gn("Canvas",i)}async function Na(c,t,e){let n=[];c.querySelectorAll("img").forEach(a=>{n.push(a)});let i=n.map(async a=>{let o,s=Ul(a.src);if(!a.src.includes("://mmbiz.qpic.cn/")){if(a.src.startsWith("data:image/"))o=li(a.src);else try{o=await kt(a.src,e)}catch(l){console.error(`Error fetching image from ${a.src}:`,l);return}o!==void 0&&await t.uploadMaterial(o,un(o.type,s)).then(l=>{l&&l.url?a.src=l.url:console.error("upload image failed.")})}}),r=await Promise.allSettled(i);gn("\u56FE\u7247",r)}function za(c,t){var a;let e=c.classList.contains("one2mp")?c:(a=c.querySelector(".one2mp"))!=null?a:c,n=e.querySelector("p"),i=t||n&&window.getComputedStyle(n).color||window.getComputedStyle(e).color||"#333333",r=o=>{o.setCssProps({color:i,opacity:"1",filter:"none"})};c.querySelectorAll(".one2mp-callout .callout-text").forEach(r),c.querySelectorAll(".one2mp-callout .callout-content p, .one2mp-callout .callout-content li").forEach(r)}async function Ba(c,t){let e=[];c.querySelectorAll("video").forEach(r=>{e.push(r)});let n=e.map(async r=>{let a;r.src.includes("://mmbiz.qpic.cn/")||(r.src.startsWith("data:image/")?a=li(r.src):a=await kt(r.src),a!==void 0&&await t.uploadMaterial(a,un(a.type),"video").then(async o=>{if(o){let s=await t.getMaterialById(o.media_id);r.src=s.url}else console.error("upload video failed.")}))}),i=await Promise.allSettled(n);gn("\u89C6\u9891",i)}var ja=y(()=>{ce();St();Ee()});var Ae,ci=y(()=>{Ae=class{constructor(){this.cardData=new Map}static getInstance(){return Ae.instance||(Ae.instance=new Ae),Ae.instance}setCardData(t,e){this.cardData.set(t,e)}cleanup(){this.cardData.clear()}restoreCard(t){for(let[e,n]of this.cardData.entries()){let r=`<section[^>]*\\sdata-id="${e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}"[^>]*>(.*?)<\\/section>`,a=new RegExp(r,"gs");if(!a.test(t)){console.warn("\u6CA1\u6709\u516C\u4F17\u53F7\u4FE1\u606F\uFF1A",e);continue}t=t.replace(a,n)}return t}}});var Z,ke=y(()=>{Z=class{constructor(t,e,n){this.plugin=t,this.previewRender=e,this.marked=n}prepare(){return Promise.resolve()}postprocess(t){return Promise.resolve(t)}beforePublish(){return Promise.resolve()}cleanup(){return Promise.resolve()}isPluginInstlled(t){let e=this.plugin.app.plugins.plugins;return Object.prototype.hasOwnProperty.call(e,t)}}});function qa(c){if(!c)return"";let t=/\[!(.*?)\]/,e=c.match(t);return e?e[1].trim():""}function fi(c){return c?c.split(/\r?\n/).map(t=>t.replace(/^>\s?/,"")).join(`
`).trim():""}function Xl(c,t){let e=c.charAt(0).toUpperCase()+c.slice(1).toLowerCase(),n=t.indexOf("]")+1;(t.indexOf("]-")>0||t.indexOf("]+")>0)&&(n=n+1);let i=t.indexOf(`
`);if(i===-1&&(i=t.length),n>=i)return e;let r=t.slice(n,i).trim();return r!==""&&(e=r),e}function Ql(c){return c&&c.replace(/<p([^>]*)>([\s\S]*?)<\/p>/g,'<p$1><span class="callout-text">$2</span></p>')}var Gl,di,Kl,Jl,pi,hi,ui,gi,mi,Va,Zl,Yl,Ua,Wa,mn,Ga=y(()=>{ke();Gl='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-pencil"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"></path><path d="m15 5 4 4"></path></svg>',di='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-clipboard-list"><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><path d="M12 11h4"></path><path d="M12 16h4"></path><path d="M8 11h.01"></path><path d="M8 16h.01"></path></svg>',Kl='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-info"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>',Jl='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-check-circle-2"><circle cx="12" cy="12" r="10"></circle><path d="m9 12 2 2 4-4"></path></svg>',pi='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-flame"><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z"></path></svg>',hi='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-check"><path d="M20 6 9 17l-5-5"></path></svg>',ui='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-help-circle"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><path d="M12 17h.01"></path></svg>',gi='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-alert-triangle"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"></path><path d="M12 9v4"></path><path d="M12 17h.01"></path></svg>',mi='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-x"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg>',Va='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',Zl='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-bug"><path d="m8 2 1.88 1.88"></path><path d="M14.12 3.88 16 2"></path><path d="M9 7.13v-1a3.003 3.003 0 1 1 6 0v1"></path><path d="M12 20c-3.3 0-6-2.7-6-6v-3a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v3c0 3.3-2.7 6-6 6"></path><path d="M12 20v-9"></path><path d="M6.53 9C4.6 8.8 3 7.1 3 5"></path><path d="M6 13H2"></path><path d="M3 21c0-2.1 1.7-3.9 3.8-4"></path><path d="M20.97 5c0 2.1-1.6 3.8-3.5 4"></path><path d="M22 13h-4"></path><path d="M17.2 17c2.1.1 3.8 1.9 3.8 4"></path></svg>',Yl='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-list"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>',Ua='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-quote"><path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z"></path><path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1z"></path></svg>',Wa=new Map(Object.entries({note:{icon:Gl},abstract:{icon:di},summary:{icon:di},tldr:{icon:di},info:{icon:Kl},todo:{icon:Jl},tip:{icon:pi},hint:{icon:pi},important:{icon:pi},success:{icon:hi},check:{icon:hi},done:{icon:hi},question:{icon:ui},help:{icon:ui},faq:{icon:ui},warning:{icon:gi},caution:{icon:gi},attention:{icon:gi},failure:{icon:mi},fail:{icon:mi},missing:{icon:mi},danger:{icon:Va},error:{icon:Va},bug:{icon:Zl},example:{icon:Yl},quote:{icon:Ua},cite:{icon:Ua}}));mn=class extends Z{prepare(){return this.marked||console.error("marked is not ready"),Promise.resolve()}async rendererBlockquote(t){let e=t.text||fi(t.raw||"");return`<blockquote dir="auto"><span class="icon-pin"></span><div class="blockquote-inner">${(await this.marked.parseInline(e)).replace(/\n/gm,"<br>").trim()}</div></blockquote>`}async rendererCallout(t){let e=t.text||fi(t.raw||""),n=qa(e);if(!n)return this.rendererBlockquote(t);let i=n.toLowerCase(),r=Xl(n,e),a=e.indexOf(`
`),o="";if(a>0){let d=e.slice(a+1).trim();d&&(o=await this.marked.parse(d)),!o&&d&&(o=(await this.marked.parseInline(d)).replace(/\n/gm,"<br>")),o=Ql(o)}let s=Wa.get(i)||Wa.get("note"),l=s?s.icon:"";return`<section class="one2mp-callout" data-callout="${i}"><div class="callout-title"><div class="callout-icon">${l}</div><div class="callout-title-inner">${r}</div></div><div class="callout-content">${o}</div></section>`}markedExtension(){return{async:!0,walkTokens:async t=>{if(t.type!=="blockquote")return;let e=t,n=e.raw||"",i=fi(n);!e.text&&i&&(e.text=i),qa(i||e.text)?t.html=await this.rendererCallout(e):t.html=await this.rendererBlockquote(e)},extensions:[{name:"blockquote",level:"block",renderer:t=>t.html}]}}}});var ec,fn,tc,Dt,nc,ic,Ka,Ja,Za=y(()=>{ec=c=>c&&c.replace(/&quot;/g,'"').replace(/&#39;/g,"'").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&"),fn=c=>c.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),tc=c=>{let t=c.match(/```mpcard\s*([\s\S]*?)```/i);return t?t[1].trim():c.trim()},Dt=(c,t)=>{var i,r;let e=new RegExp(`\\b${t}=("([^"]*)"|'([^']*)')`,"i"),n=c.match(e);return n?ec(((r=(i=n[2])!=null?i:n[3])!=null?r:"").trim()):""},nc=c=>{let t=c.split(/\r?\n/).map(i=>i.trim()).filter(i=>i.length>0),e={},n=/^(\w+):\s*"?(.*?)"?$/;for(let i of t){let r=i.match(n);if(r){let a=r[1].trim().toLowerCase(),o=r[2].trim();e[a]=o}}return{id:e.id||"",headimg:e.headimg||e.avatar||"",nickname:e.nickname||e.name||"",signature:e.signature||e.desc||e.description||"",alias:e.alias||""}},ic=c=>{let t=tc(c);if(!t)return null;if(/<mp-common-profile/i.test(t)||/\bdata-id=/.test(t))return{id:Dt(t,"data-id"),headimg:Dt(t,"data-headimg"),nickname:Dt(t,"data-nickname"),signature:Dt(t,"data-signature"),alias:Dt(t,"data-alias"),rawHtml:t};let e=nc(t);return{id:e.id||"",headimg:e.headimg||"",nickname:e.nickname||"",signature:e.signature||"",alias:e.alias,rawHtml:""}},Ka=c=>{let t=ic(c);if(!t||!t.id||!t.rawHtml)return null;let e=t.rawHtml.trim();return/<mp-common-profile/i.test(e)?(/^\s*<section/i.test(e)||(e=`<section class="mp_profile_iframe_wrp" nodeleaf="">${e}</section>`),{info:t,html:e}):null},Ja=c=>{let t=fn(c.headimg||""),e=fn(c.nickname||""),n=fn(c.signature||"");return`<section${c.id?` data-id="${fn(c.id)}"`:""} class="one2mp-mpcard-wrapper"><div class="one2mp-mpcard-content"><img class="one2mp-mpcard-headimg" width="54" height="54" src="${t}"></img><div class="one2mp-mpcard-info"><div class="one2mp-mpcard-nickname">${e}</div><div class="one2mp-mpcard-signature">${n}</div></div></div><div class="one2mp-mpcard-foot">\u516C\u4F17\u53F7</div></section>`}});var Ya,vn,Xa=y(()=>{ce();St();Ee();It();ke();Ya=require("obsidian");ci();Za();vn=class extends Z{constructor(){super(...arguments);this.mermaidIndex=0;this.admonitionIndex=0;this.chartsIndex=0}prepare(){return this.mermaidIndex=0,this.admonitionIndex=0,this.chartsIndex=0,Ae.getInstance().cleanup(),Promise.resolve()}static srcToBlob(e){let n=e.split(",")[1],i=atob(n),r=new Array(i.length);for(let o=0;o<i.length;o++)r[o]=i.charCodeAt(o);let a=new Uint8Array(r);return new Blob([a],{type:"image/png"})}getHighlightProfile(e){if(!e)return null;let n=e.toLowerCase(),i=new Set(["const","let","var","function","return","if","else","for","while","switch","case","break","continue","class","new","this","try","catch","finally","throw","import","export","from","extends","super","await","async","typeof","instanceof","in","of","interface","type","enum","public","private","protected","readonly","implements","constructor","static","get","set"]),r=new Set(["def","class","import","from","return","if","elif","else","for","while","try","except","finally","with","as","pass","break","continue","lambda","yield","True","False","None"]),a=new Set(["true","false","null"]),o=new Set(["if","then","fi","for","do","done","case","esac","function","in","while","until","return","export","local","readonly"]);return{js:{keywords:i,lineComment:"//",blockComment:{start:"/*",end:"*/"},allowBacktick:!0},javascript:{keywords:i,lineComment:"//",blockComment:{start:"/*",end:"*/"},allowBacktick:!0},ts:{keywords:i,lineComment:"//",blockComment:{start:"/*",end:"*/"},allowBacktick:!0},typescript:{keywords:i,lineComment:"//",blockComment:{start:"/*",end:"*/"},allowBacktick:!0},json:{keywords:a},py:{keywords:r,lineComment:"#"},python:{keywords:r,lineComment:"#"},sh:{keywords:o,lineComment:"#"},bash:{keywords:o,lineComment:"#"},shell:{keywords:o,lineComment:"#"},zsh:{keywords:o,lineComment:"#"}}[n]||null}escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}preserveSpaces(e){return e.replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/ /g,"&nbsp;")}isIdentifierStart(e){let n=e.charCodeAt(0);return n>=65&&n<=90||n>=97&&n<=122||e==="_"||e==="$"}isIdentifierPart(e){let n=e.charCodeAt(0);return n>=48&&n<=57||n>=65&&n<=90||n>=97&&n<=122||e==="_"||e==="$"}highlightLine(e,n,i){let r=[],a=0,o=(l,d)=>{d&&r.push({type:l,text:d})};for(;a<e.length;){let l=e[a];if(n.inBlockComment&&i.blockComment){let p=e.indexOf(i.blockComment.end,a);if(p>=0){o("comment",e.slice(a,p+i.blockComment.end.length)),a=p+i.blockComment.end.length,n.inBlockComment=!1;continue}o("comment",e.slice(a)),a=e.length;continue}if(n.inString){let p="";for(;a<e.length;){let h=e[a];if(p+=h,h==="\\"&&a+1<e.length){p+=e[a+1],a+=2;continue}if(a+=1,h===n.stringChar){n.inString=!1;break}}o("string",p);continue}if(i.lineComment&&e.startsWith(i.lineComment,a)){o("comment",e.slice(a));break}if(i.blockComment&&e.startsWith(i.blockComment.start,a)){n.inBlockComment=!0;continue}if(l==="'"||l==='"'||l==="`"&&i.allowBacktick){n.inString=!0,n.stringChar=l;continue}if(l===" "||l==="	"){let p=a;for(;a<e.length&&(e[a]===" "||e[a]==="	");)a+=1;o("plain",e.slice(p,a));continue}let d=l.charCodeAt(0);if(d>=48&&d<=57||l==="."&&a+1<e.length&&e[a+1]>="0"&&e[a+1]<="9"){let p=a;for(a+=1;a<e.length;){let h=e[a];if(h>="0"&&h<="9"||h==="."||h==="_"||h==="x"||h==="X"||h>="a"&&h<="f"||h>="A"&&h<="F"){a+=1;continue}break}o("number",e.slice(p,a));continue}if(this.isIdentifierStart(l)){let p=a;for(a+=1;a<e.length&&this.isIdentifierPart(e[a]);)a+=1;let h=e.slice(p,a);i.keywords.has(h)?o("keyword",h):o("plain",h);continue}o("plain",l),a+=1}return{html:r.map(l=>{let d=this.preserveSpaces(this.escapeHtml(l.text));return l.type==="plain"?d:`<span class="o2any-token-${l.type}">${d}</span>`}).join(""),state:n}}codeRenderer(e,n){var h;let i=(h=(n||"").match(/^\S*/))==null?void 0:h[0],r=e.replace(/\n$/,""),a=this.getHighlightProfile(i||""),o=r.split(/\r?\n/),s="",l={inBlockComment:!1,inString:!1,stringChar:""};for(let g of o){let m=g;if(a){let f=this.highlightLine(g,l,a);m=f.html,l.inBlockComment=f.state.inBlockComment,l.inString=f.state.inString,l.stringChar=f.state.stringChar}else m=this.preserveSpaces(this.escapeHtml(g));m.length===0&&(m="<br>"),s+="<code>"+m+"</code>"}let d='<section class="code-section code-snippet__fix">',p="";return i?p=d+`<pre style="max-width:1000% !important;" class="hljs o2any-codeblock language-${i}">${s}</pre></section>`:p=d+`<pre class="hljs o2any-codeblock">${s}</pre></section>`,p}static getMathType(e){if(!e)return null;let n=e.toLowerCase();return n=n.trim(),n==="am"||n==="asciimath"?"asciimath":n==="latex"||n==="tex"?"latex":null}renderAdmonition(e,n){let i=re.getInstance(this.plugin.app).queryElement(this.admonitionIndex,".callout.admonition");if(!i)return u("render.admonition-failed");this.admonitionIndex++;let r=i.querySelector(".edit-block-button");r&&r.parentNode.removeChild(r);let a=i.querySelector(".callout-fold");if(a)try{a.parentNode.removeChild(a)}catch(o){console.error(o)}return Pe(i)}renderAdmonitionAsync(e,n){let r=re.getInstance(this.plugin.app).queryElement(this.admonitionIndex,".callout.admonition");if(!r)return u("render.admonition-failed");this.admonitionIndex++;let a=r.querySelector(".edit-block-button");a&&a.parentNode.removeChild(a);let o=r.querySelector(".callout-fold");if(o)try{o.parentNode.removeChild(o)}catch(s){console.error(s)}return la(r)}async renderMermaidAsync(e){var d;e.html=u("render.mermaid-failed");let n=this.mermaidIndex;this.mermaidIndex++;let i=re.getInstance(this.plugin.app),r=i.queryElement(n,".mermaid");if(!r)return;await i.waitForSelector(r,"svg",5e3);let a=r.querySelector("svg");if(!a)return;let o=r.closest(".one2mp-render-preview"),s=(d=o==null?void 0:o.classList.contains("one2mp-render-preview-visible"))!=null?d:!1,l=r.classList.contains("one2mp-mermaid-visible");try{o==null||o.classList.add("one2mp-render-preview-visible"),r.classList.add("one2mp-mermaid-visible");let{width:p,height:h}=this.getMermaidSize(a),g=await i.domToImage(a,{width:p,height:h});e.html=`<section id="one2mp-mermaid-${n}" class="mermaid"><img src="${g}" class="mermaid-image" style="width:${p}px;height:auto;"></section>`}catch(p){console.error(p)}finally{o&&!s&&o.classList.remove("one2mp-render-preview-visible"),l||r.classList.remove("one2mp-mermaid-visible")}}getMermaidSize(e){var a;let n=e.getBoundingClientRect(),i=Math.round(n.width),r=Math.round(n.height);if(!i||!r){let o=(a=e.viewBox)==null?void 0:a.baseVal;o&&o.width&&o.height&&(i=Math.round(o.width),r=Math.round(o.height))}if(!i||!r){let o=e.getAttribute("width"),s=e.getAttribute("height"),l=o?parseFloat(o):0,d=s?parseFloat(s):0;l&&(i=Math.round(l)),d&&(r=Math.round(d))}return i||(i=800),r||(r=400),{width:i,height:r}}renderCharts(e){if(!this.isPluginInstlled("obsidian-charts"))return console.debug("charts plugin not installed."),new Ya.Notice(u("rnder.charts-plugin-not-installed")),!1;let n=this.plugin.resourceManager.getMarkdownRenderedElement(this.chartsIndex,".block-language-chart");if(!n)return u("render.charts-failed");let i=`charts-img-${this.chartsIndex}`;this.chartsIndex++;let r=n.querySelector("canvas");if(r){let a="image/png",o=r.toDataURL(a);return`<section id="${i}" class="charts" >
...
${n}
\`\`\`
`}};var mt="one2mp-article-preview",fc={mpAccounts:[],ipAddress:"",css_styles_folder:"one2mp-css-styles",codeLineNumber:!0,accountDataPath:"one2mp-accounts",useCenterToken:!1,realTimeRender:!0,defaultMpcard:"",defaultMpcardId:"",defaultMpcardHeadimg:"",defaultMpcardNickname:"",defaultMpcardSignature:"",themeDownloadOverwrite:!1,haloSites:[],selectedHaloSite:"",haloPublishByDefault:!0},Ao="one2mp-logo",vc=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
...
${e.stack}`:""}`:String(e)}createSpinner(){this.spinner=new sn(this.addStatusBarItem())}showSpinner(e=""){this.spinner.showSpinner(e)}isSpinning(){return this.spinner.isSpinning()}hideSpinner(){this.spinner.hideSpinner()}async loadSettings(){this.settings=Object.assign({},fc,await aa(this)),await this.loadThemeFolder()}async updateIpAddress(){try{let e=await Ci();return this.settings.ipAddress=JSON.stringify(e),this.saveSettings(),e}catch(e){return console.error("Error fetching public IP address:",e),{}}}async activateView(){let{workspace:e}=this.app,n=e.getLeavesOfType(mt).find(i=>i.view.getViewType()===mt);n==null&&(n=e.getRightLeaf(!1),await(n==null?void 0:n.setViewState({type:mt,active:!0}))),n&&e.revealLeaf(n)}getAccessToken(e){let n=this.getMPAccountByName(e);return n===void 0?(new Se.Notice(u("main.no-wechat-mp-account-selected")),!1):n.access_token}async TestAccessToken(e){if(this.settings.useCenterToken)return this.wechatClient.requestToken();{let n=this.getMPAccountByName(e);if(n===void 0)return new Se.Notice(u("main.no-wechat-mp-account-selected")),!1;let i=await this.wechatClient.getAccessToken(n.appId,n.appSecret);if(i)return this.setAccessToken(e,i.access_token,i.expires_in),i.access_token}return!1}async refreshAccessToken(e){if(this.settings.useCenterToken)return this.wechatClient.requestToken();if(e===void 0)return!1;let n=this.getMPAccountByName(e);if(n===void 0)return new Se.Notice(u("main.no-wechat-mp-account-selected")),!1;let{appId:i,appSecret:r}=n;if(i===void 0||r===void 0||!i||!r)return new Se.Notice(u("main.please-check-you-appid-and-appsecret")),!1;let{access_token:a,expires_in:o,lastRefreshTime:s}=n;if(a===void 0||a===""){let l=await this.wechatClient.getAccessToken(i,r);if(l)return this.setAccessToken(e,l.access_token,l.expires_in),l.access_token}else if(s+o*1e3<new Date().getTime()){let l=await this.wechatClient.getAccessToken(i,r);if(l)return this.setAccessToken(e,l.access_token,l.expires_in),l.access_token}else return a;return!1}getMPAccountByName(e){return this.settings.mpAccounts.find(n=>n.accountName===e)}getSelectedMPAccount(){return this.getMPAccountByName(this.settings.selectedMPAccount)}setAccessToken(e,n,i){let r=this.getMPAccountByName(e);r!==void 0&&(r.access_token=n,r.lastRefreshTime=new Date().getTime(),r.expires_in=i,this.saveSettings())}confirm(e){return new Promise(n=>{new Ut(this.app,e,n).open()})}initDB(){ra(),Kn()}async onload(){await this.writeStartupLog("onload:start");try{this.initDB(),this.messageService=new Xt,await this.loadSettings(),this.wechatClient=Me.getInstance(this),this.haloClient=new on(this),(0,Se.addIcon)(Ao,vc);let e=await Promise.resolve().then(()=>(Mo(),Eo));this.previewPanelCtor=e.PreviewPanel,this.registerViews(),this.addCommand({id:"open-previewer",name:u("main.open-previewer"),callback:()=>{this.activateView()}}),this.addRibbonIcon(Ao,u("main.open-previewer"),()=>{this.activateView()}),this.addSettingTab(new Zt(this.app,this)),this.createSpinner(),this.messageService.registerListener("show-spinner",n=>{this.showSpinner(n)}),this.messageService.registerListener("hide-spinner",()=>{this.hideSpinner()}),this.registerEvent(this.app.workspace.on("editor-menu",(n,i)=>{n.addItem(r=>{r.setTitle(u("main.insert-mpcard")),r.onClick(()=>{let a=this.settings.defaultMpcard||this.buildDefaultMpcard();new ln(this.app,s=>{i.replaceSelection(s)},a).open()})})}))}catch(e){throw await this.writeStartupLog("onload:error",e),e}await this.writeStartupLog("onload:ready")}buildDefaultMpcard(){var o,s,l,d;let e=[],n=(o=this.settings.defaultMpcardId)==null?void 0:o.trim(),i=(s=this.settings.defaultMpcardHeadimg)==null?void 0:s.trim(),r=(l=this.settings.defaultMpcardNickname)==null?void 0:l.trim(),a=(d=this.settings.defaultMpcardSignature)==null?void 0:d.trim();return n&&e.push(`id: ${n}`),i&&e.push(`headimg: ${i}`),r&&e.push(`nickname: ${r}`),a&&e.push(`signature: ${a}`),e.length===0?"":["```mpcard",...e,"```"].join(`
`)}registerViewOnce(e){if(this.app.workspace.getLeavesOfType(e).length===0&&e===mt){if(!this.previewPanelCtor){new Se.Notice("\u9884\u89C8\u5668\u672A\u52A0\u8F7D\uFF0C\u65E0\u6CD5\u6CE8\u518C\u89C6\u56FE");return}this.registerView(e,n=>new this.previewPanelCtor(n,this))}}registerViews(){this.registerViewOnce(mt)}onunload(){this.editorChangeListener&&this.app.workspace.offref(this.editorChangeListener),this.spinner.unload(),this.app.workspace.getLeavesOfType(mt).forEach(e=>e.detach()),Me.resetInstance(),(async()=>{let{ThemeManager:e}=await Promise.resolve().then(()=>(yt(),Jt));e.resetInstance()})(),(async()=>{let{LocalDraftManager:e}=await Promise.resolve().then(()=>(Ct(),pa));e.resetInstance();let{WechatRender:n}=await Promise.resolve().then(()=>(bi(),yo));n.resetInstance()})()}};
//![[]]
